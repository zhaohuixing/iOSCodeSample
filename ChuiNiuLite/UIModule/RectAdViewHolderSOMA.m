...
//
#import "RectAdViewHolderSOMA.h"
#import "ApplicationConfigure.h"
#import "GUILayout.h"
#import "StringFactory.h"
#import "iSoma/SOMAGlobalSettings.h"

@implementation RectAdViewHolderSOMA
...
-(void)InitGoogleUnit
{
    ...
    {
        m_SOMABannerView = [[SOMABannerView alloc] initWithDimension:kSOMAAdDimensionMediumRectangle];
        
        
        [m_SOMABannerView adSettings].adType = kSOMAAdTypeAll;
        m_SOMABannerView.autoresizingMask = UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleRightMargin;
        m_SOMABannerView.center = CGPointMake(150, 125);
        ...
        [SOMAGlobalSettings globalSettings].userSettings.age = 30;
    }    
}
...
-(void)OpenAdView
{
    ...
    m_nPrevAdType = ADVIEW_TYPE_MOBCLIX;
