...
+(int)GetString_OSLangID
{
	...
	if([str isEqualToString:@"0"] == YES)
		...
		nRet = LANGID_ES;
	else if([str isEqualToString:@"10"] == YES)
		nRet = LANGID_THAI;
...
{
	NSString* str = @"CHUINIULITE_KEY_TOTAL_SCORE"; 
...
{
	NSString* str = @"Play Current Game";
	
	str = NSLocalizedString(@"Play Current Game", @"Play Current Game label string");
...
{
	NSString* str = @"Play Next Level Game";
	
	str = NSLocalizedString(@"Play New Level Game", @"Try Agin label string");
...
+(NSString*)GetString_PostGameScore
{
	...
	str = NSLocalizedString(@"Post Score", @"Post Score label string");
...
{
	NSString* str = @"Share Game Result";
	
	str = NSLocalizedString(@"Share Game Result", @"Share Game Result label string");
...
{
	NSString* str = @"Game Total Score";
	
	str = NSLocalizedString(@"Game Total Score", @"Game Total Score label string");
...
{
	NSString* str = @"Cannot play selected game";
	
	str = NSLocalizedString(@"Cannot play selected game", @"Cannot play selected game string");
...
{
	NSString* str = @"Lost Score";
	
	str = NSLocalizedString(@"Lost Score/Per Game", @"Lost score label string");
...
{
	NSString* str = @"Required Score";
	
	str = NSLocalizedString(@"Required Score/Per Game", @"Lost score label string");
...
{
    return @"CHUINIULITE_KEY_ACHIEVEMENT1";
}

+(NSString*)GetString_Achievement2Key
{
    return @"CHUINIULITE_KEY_ACHIEVEMENT2";
}

+(NSString*)GetString_Achievement3Key
{
    return @"CHUINIULITE_KEY_ACHIEVEMENT3";
}

+(NSString*)GetString_Achievement4Key
{
    return @"CHUINIULITE_KEY_ACHIEVEMENT4";
}

+(NSString*)GetString_Me
{
	NSString* str = @"Records";
	
	str = NSLocalizedString(@"Records", @"Records label string");
...
+(NSString*)GetString_Congratulation
{
	...
	str = NSLocalizedString(@"Congratulation!", @"Congratulation label string");
...
{
	NSString* str = @"AskAWSService";
	
	str = NSLocalizedString(@"AskAWSService", @"AskAWSService label string");
    return str;
}
...
{
	NSString* str = @"StartOnlineGame";
	
	str = NSLocalizedString(@"StartOnlineGame", @"StartOnlineGame label string");
    return str;
}

+(NSString*)GetString_AskAWSServiceEnableKey
{
	NSString* str = @"CHUINIUZH_KEY_AWSSERVICEDISABLE"; 
...
{
	NSString* str = @"AWS Service Failed";
	
	str = NSLocalizedString(@"AWS Service Failed", @"AWS Service Failed label string");
    return str;
}
...
+(NSString*)GetString_Won
{
	...
	str = NSLocalizedString(@"Won", @"Won string");
    return str;
}
...
+(NSString*)GetString_Lost
{
	...
	str = NSLocalizedString(@"Lost", @"Lost label string");
    return str;
}
