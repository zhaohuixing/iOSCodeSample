//
//  XZBaseDateConstraints.m
//

#import "XZBaseDateConstraints.h"
#import "NSDate+XZCareBase.h"

@implementation XZBaseDateConstraints
...
{
    [super DebugLog];
    NSLog(@"XZBaseDateConstraints DebugLog allowFuture:%@\n", [self.allowFuture description]);
    NSLog(@"XZBaseDateConstraints DebugLog earliestValue:%@\n", [self.earliestValue ISO8601String]);
    NSLog(@"XZBaseDateConstraints DebugLog latestValue:%@\n", [self.latestValue ISO8601String]);
