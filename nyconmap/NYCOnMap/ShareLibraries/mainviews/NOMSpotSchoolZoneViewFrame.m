...
@interface NOMSpotSchoolZoneViewFrame ()
{
    NOMSpotSchoolZoneContentView*         m_SpotDetailView;
}

@end

@implementation NOMSpotSchoolZoneViewFrame
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        m_SpotDetailView = [[NOMSpotSchoolZoneContentView alloc] initWithFrame:rect];
