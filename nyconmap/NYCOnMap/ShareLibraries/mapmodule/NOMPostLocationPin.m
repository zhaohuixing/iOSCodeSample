...
@implementation NOMPostLocationPin
...
-(void)InitWithSubControls
{
    ...
    CGRect rect = CGRectMake(self.frame.size.width-w, sy, w, h);
...
- (id)initWithAnnotation:(id <MKAnnotation>)annotation reuseIdentifier:(NSString *)reuseIdentifier withSize:(CGSize)size withOK:(int)nOKButtonID withCancel:(int)nCancelButtonID
{
    ...
    if (self != nil)
    {
        ...
        m_PinImage = [ImageLoader LoadImageWithName:@"postpin200.png"];
...
{
    //CGContextDrawImage(context, rect, m_PinImage);
