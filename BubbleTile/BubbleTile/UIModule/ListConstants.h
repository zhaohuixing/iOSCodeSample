...
@protocol ListCellDataTemplate <NSObject>
-(enLISTCELLDATATYPE)GetDataType; 
-(void)Destroy;
@end

@protocol ListCellDataIntegerTemplate <NSObject>
-(int)GetData;  
@end

@protocol ListCellDataFloatTemplate <NSObject>
-(float)GetData;  
@end
...
@protocol ListCellDataStringTemplate <NSObject>
-(NSString*)GetData;  
@end

@protocol ListCellDataObjectTemplate <NSObject>
-(id)GetData;  
@end

@protocol ListCellTemplate <NSObject>
...
@protocol ListCellGroupTemplate <NSObject>
...
@protocol ListCellAdBannerTemplate <NSObject>
-(void)RefreshAd;
@end

@protocol ListContentViewTemplate <NSObject>
-(void)OnUnCheckAllCells:(id)sender;
-(void)OnUnSelectAllCells:(id)sender;
-(void)OnCellSelectedEvent:(id)sender;
-(float)GetListHeight;
...
@protocol ListContainerTemplate <NSObject>
-(void)OnCellSelectedEvent:(id)sender;
