...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) 
    {
		...
		m_Button1 = [[[UIButton alloc] initWithFrame:innerRect] autorelease];
        ...
        sx -= w;
        innerRect = CGRectMake(sx, sy, w, h);
		m_Button2 = [[[UIButton alloc] initWithFrame:innerRect] autorelease];
        ...
        sx -= w;
        innerRect = CGRectMake(sx, sy, w, h);
		m_Button3 = [[[UIButton alloc] initWithFrame:innerRect] autorelease];
        ...
        sx -= w;
        innerRect = CGRectMake(sx, sy, w, h);
		m_Button4 = [[[UIButton alloc] initWithFrame:innerRect] autorelease];
